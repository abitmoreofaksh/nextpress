...
const BorderRayCard = () => {
  return (
    <motion.div
      ...
      className="bg-gradient-to-b w-96 from-neutral-50 dark:from-neutral-950 to-neutral-100 dark:to-neutral-900 rounded-xl p-8 border border-gray-300 dark:border-gray-800  transition-all duration-300 group relative overflow-hidden"
    >
      <div className="relative z-10 col-span-11 flex flex-col justify-between h-full">
        <div>
          ...
          >
            Team members are individuals who work collaboratively within a group
